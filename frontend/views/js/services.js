...
ParkMe.factory('getParkingSpots', function($http,$rootScope){
    return{
        availableSpots: function(lat, lon){
            var numSpots = 20;
            $http.get('https://easyparkrealtime.herokuapp.com//get_nearest_spot/'+numSpots+'/'+lat+'/'+lon+'/').success(function(data){
                var spots = [];
        ...
        getDailyAggregate: function(date){
            $http.get('https://easyparkrealtime.herokuapp.com//get_availability_daily/'+date).success(function(data){
                var spots = [];
        ...
        getHourlyAggregate: function(date, spot_name){
            ...
            $http.get('https://easyparkrealtime.herokuapp.com//get_availability_hourly/'+date+'/'+spot_name).success(function(data){
                var spots = [];
                console.log(data);
